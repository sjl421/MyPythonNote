    ...
    if len(name.split('.')) == 2:
        ...
        if name.split('.')[1].upper() in getVideo():
            ...
            try:
                os.mkdir("Compressed")
                print
                "Compressed Folder Created"
            except WindowsError:
                print
                "Compressed Folder Exists"
...
print
"Done Arranging Files and Folder in your specified directory"
